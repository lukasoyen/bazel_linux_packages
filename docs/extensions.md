...
apt.install(<a href="#apt.install-name">name</a>, <a href="#apt.install-architecture">architecture</a>, <a href="#apt.install-build_file">build_file</a>, <a href="#apt.install-source">source</a>)
</pre>
...
| <a id="apt.install-source"></a>source |  download() repositorie to unpack packages from   | String | optional |  `"download"`  |
