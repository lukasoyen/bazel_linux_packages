...
apt.install(<a href="#apt.install-name">name</a>, <a href="#apt.install-architecture">architecture</a>, <a href="#apt.install-build_file">build_file</a>, <a href="#apt.install-extra_patchelf_dirs">extra_patchelf_dirs</a>, <a href="#apt.install-fix_interpreter_with_patchelf">fix_interpreter_with_patchelf</a>,
...
| <a id="apt.install-fix_interpreter_with_patchelf"></a>fix_interpreter_with_patchelf |  Whether to fix the interpreter of executables using `patchelf`   | Boolean | optional |  `False`  |
