...
This means that any usage of `@bazel_linux_packages` on your system will point to this folder.
...
https://github.com/lukasoyen/bazel_linux_packages/actions/workflows/tag.yaml
